...
const mockSensorStatus = {
  ...
  elegoo: {
    lastStatusUpdateTimestamp: 1750975061,
    mainboardID: "asdf",
    printStatus: 0,
    isPrinting: false,
    currentLayer: 0,
    ...
    nozzleTempC: 128.3,
    nozzleTargetTempC: 210,
    bedTempC: 60.3,
    bedTargetTempC: 70,
    chamberTempC: 30.45,
    chamberTargetTempC: 0
  },
  heater: {
    chamberTempC: 30.45,
    chamberTargetTempC: 40,
    timerActive: true,
    remainingTime: 3650,
    isAuto: false
  }
...
async function createServer() {
  ...
  app.use("/sensor_status", async (req, res) => {
    res.setHeader("Content-Type", "application/json");
    mockSensorStatus.elegoo.lastStatusUpdateTimestamp = Date.now()/1000;//-randomInt(0, 10000);
    ...
    <div class="flex flex-col items-center mt-12 mb-16">
      ...
      <div class="flex flex-col justify-center mt-10">
        <a href="https://elegantota.pro" target="_blank" class="flex flex-row p-3 border bg-gray-50 dark:bg-transparent border-[#b0b3b8] rounded-lg border-opacity-30 relative">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-yellow-400"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
          ...
          <!-- <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-yellow-500"><path fill="currentColor" d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg> -->
        </a>
      </div>
    </div>
