    ...
    <div class="flex flex-col items-center mt-12 mb-16">
      ...
      <div class="flex flex-col justify-center mt-10">
        <a href="https://elegantota.pro" target="_blank" class="flex flex-row p-3 border bg-gray-50 dark:bg-transparent border-[#b0b3b8] rounded-lg border-opacity-30 relative">
          ...
          <!-- <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-yellow-500"><path fill="currentColor" d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c1.62-1.08 5 0 5 0"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg> -->
        </a>
      </div>
    </div>
