...
// mbedtls 3.x dropped the _ret-suffixed names; the production code now calls
// the unsuffixed forms. Provide them as aliases so the desktop mock matches
// the real 3.x API the firmware links against.
