...
// Include test build includes first
// #include "build_includes.h"

// Now include the real Logger.h
// #include "Arduino.h"
#include "Logger.h"
#include "MockHAL.h"

// Provide the missing external dependencies that Logger.cpp expects
const char* hostName = "CoopControllerTest";
const char* syslogServer = "192.168.2.202";
const char* syslogPort = "514";

// Instantiate MDNS
// ESPmDNSClass MDNS;

// // Implement external function that Logger.cpp expects
// unsigned long getTime() {
//     static unsigned long time_counter = 1609459200; // Jan 1, 2021 00:00:00 UTC
//     return ++time_counter; // Return incrementing time for each call
// }

// // Implement external WifiController that Logger.cpp expects
// // Note: Can't instantiate here due to constructor requirements
// // Define as extern and will be mocked in tests

// // Implement FreeRTOS stub functions
// extern "C" {
//     uint32_t xPortGetCoreID() { return 1; }
//     void* xTaskGetCurrentTaskHandle() { return (void*)1; }
//     void esp_task_wdt_reset() {}
//     void esp_task_wdt_init() {}
//     void esp_task_wdt_add() {}
...
//     EXPECT_EQ(logger_instance.getLogLevel(), LogLevel::INFO);  // Default should be INFO
// }
